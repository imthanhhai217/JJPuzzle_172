...
import com.pachia.balat.demo.utils.Security;
...
public class InAppPurchaseActivity extends AppCompatActivity implements PurchasesUpdatedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getPurchaseValueFromPref()) {
            ...
            tvStatus.setText("Thanks for support");
        } else {
            btnPurchase.setVisibility(View.VISIBLE);
            tvStatus.setText("Become supporter");
        }
    }
        ...
        for (Purchase purchase : purchases) {
            if (PRODUCT_ID.equals(purchase.getSkus().get(0)) && purchase.getPurchaseState() == Purchase.PurchaseState.PURCHASED) {
                ...
                if (!purchase.isAcknowledged()) {
                    ...
                    //todo check pref device, email purchase success
                    if (!getPurchaseValueFromPref()) {
                ...
                savePurchaseValueToPref(false);
                tvStatus.setText("Purchase Status : Not Purchased");
                btnPurchase.setVisibility(View.VISIBLE);
