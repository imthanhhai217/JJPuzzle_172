...
public class SuphoWebView extends WebView {

	private OnPropertyChangedListener mOnScrollChangedCallback;	

	public SuphoWebView(final Context context) {
		super(context);
	}

	public SuphoWebView(final Context context, final AttributeSet attrs) {
		super(context, attrs);
	}

	public SuphoWebView(final Context context, final AttributeSet attrs, final int defStyle) {
